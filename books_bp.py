...
def create_url_dict(href_values):
    url_dict = {}
...
def clean_price(price_text):
    # tar bort Â£ med regex då det är bara siffror och punkt
...
@books_bp.route("/categories/<category>")
...
@books_bp.route("/books/<category>", methods=["POST"])
...
@books_bp.route("/books/<category>/<book_id>", methods=["GET"])
...
@books_bp.route("/books/<category>/<book_id>", methods=["PUT"])
...
@books_bp.route("/books/<category>/<book_id>", methods=["DELETE"])
